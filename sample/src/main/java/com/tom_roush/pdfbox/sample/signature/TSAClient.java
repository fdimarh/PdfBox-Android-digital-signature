 ...
 */
package com.tom_roush.pdfbox.sample.signature;
...
public class TSAClient
{
    ...
    {
        Log.d(this.getClass().getName(),"Opening connection to TSA server");
        ...
        Log.d(this.getClass().getName(),"Established connection to TSA server");
        ...
        Log.d(this.getClass().getName(),"Waiting for response from TSA server");
        ...
        Log.d(this.getClass().getName(),"Received response from TSA server");
